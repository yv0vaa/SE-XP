...
urlpatterns = [
    ...
    path('teacher/course/<int:pk>/students/', views.manage_students, name='manage_students'),
    path('teacher/course/<int:course_pk>/homework/create/', views.teacher_create_homework, name='teacher_create_homework'),
